...
namespace Universe.Coin.Upbit
{
    ...
    public partial class Helper
    {
        ...
        static readonly string[] _englishKRW =
        {
        ...
        static readonly string[] _koreanKRW =
        {
        ...
        static readonly string[] _coinsBTC =
        {
        ...
        static readonly string[] _englishBTC =
        {
        ...
        static readonly string[] _koreanBTC =
        {
